...
function makeAllDisabledUseCases() {
  return {
    cycleCount__inventory:   { enabled: false, mode: 'reductionPct', hoursPerSession: 2, sessionsPerWeek: 3, peoplePerSession: 2, burdenedRate: 35, reductionPct: 0.98, employeesBefore: 3, hoursPerCountBefore: 40, employeesAfter: 1, hoursPerCountAfter: 2, countsPerYear: 48, justification: '', customDrivers: [], reviewed: false },
    cycleCount__asset:       { enabled: false, mode: 'reductionPct', hoursPerSession: 2, sessionsPerWeek: 3, peoplePerSession: 2, burdenedRate: 35, reductionPct: 0.98, employeesBefore: 3, hoursPerCountBefore: 40, employeesAfter: 1, hoursPerCountAfter: 2, countsPerYear: 48, justification: '', customDrivers: [], reviewed: false },
    cycleCount__wip:         { enabled: false, mode: 'reductionPct', hoursPerSession: 2, sessionsPerWeek: 3, peoplePerSession: 2, burdenedRate: 35, reductionPct: 0.98, employeesBefore: 3, hoursPerCountBefore: 40, employeesAfter: 1, hoursPerCountAfter: 2, countsPerYear: 48, justification: '', customDrivers: [], reviewed: false },
    audit:                   { enabled: false, people: 8, daysPerAudit: 2, hoursPerDay: 8, auditsPerYear: 2, burdenedRate: 35, reductionPct: 0.90, downtimeCostPerDay: '', justification: '', customDrivers: [], reviewed: false },
    ...
    workOrderTracking:       { enabled: false, roleRows: [{ id: 1, role: 'indirect', customRoleName: '', hoursLostPerDay: 0.5, headcount: defaultOps.indirectCount, burdenedRate: defaultOps.indirectRate }], reductionPct: 0.85, driver1Enabled: true, driver2Enabled: true, supervisorHoursPerWeek: 2, supervisorHeadcount: 2, supervisorBurdenedRate: 45, driver1Justification: '', driver2Justification: '', customDrivers: [], reviewed: false },
