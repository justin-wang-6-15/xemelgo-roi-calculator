...
function makeAllDisabledUseCases() {
  return {
    cycleCount:              { enabled: false, mode: 'reductionPct', hoursPerSession: 2, sessionsPerWeek: 3, peoplePerSession: 2, burdenedRate: 35, reductionPct: 0.98, employeesBefore: 3, hoursPerCountBefore: 40, employeesAfter: 1, hoursPerCountAfter: 2, countsPerYear: 48, justification: '', customDrivers: [], reviewed: false },
    ...
    locateItems:             { enabled: false, roleRows: [{ id: 1, role: 'materialHandler', customRoleName: '', hoursLostPerDay: 1.5, headcount: 10, burdenedRate: 25 }], reductionPct: 0.90, driver1Enabled: true, driver2Enabled: true, supervisorHoursPerWeek: 2, supervisorHeadcount: 2, supervisorBurdenedRate: 45, driver1Justification: '', driver2Justification: '', customDrivers: [], reviewed: false },
    ...
    rtiTracking:             { enabled: false, incidentsPerYear: 200, costPerIncident: 75,   reductionPct: 0.85, justification: '', customDrivers: [], reviewed: false },
