...
function makeAllDisabledUseCases() {
  return {
    ...
    locateItems:             { enabled: false, roleRows: [{ id: 1, role: 'materialHandler', customRoleName: '', hoursLostPerDay: 1.5, headcount: 10, burdenedRate: 25 }], reductionPct: 0.90, driverMode: 'and', activeDriver: 1, supervisorHoursPerWeek: 2, supervisorHeadcount: 2, supervisorBurdenedRate: 45 },
    picklistVerification:    { enabled: false, picksPerDay: 500, errorRate: 2, costPerError: 50, reductionPct: 0.95, driverMode: 'and', activeDriver: 1, minutesSavedPerPick: 1, burdenedRate: 25 },
    ...
    workOrderTracking:       { enabled: false, roleRows: [{ id: 1, role: 'indirect', customRoleName: '', hoursLostPerDay: 0.5, headcount: defaultOps.indirectCount, burdenedRate: defaultOps.indirectRate }], reductionPct: 0.85, driverMode: 'or', activeDriver: 1, supervisorHoursPerWeek: 2, supervisorHeadcount: 2, supervisorBurdenedRate: 45 },
